...
export default class CustomerDashboard extends Component {
  ...
  constructor(props) {
    ...
    try {
      axios.get("http://Backend-Dev-dev.us-east-1.elasticbeanstalk.com/api/booking/all/user/" + this.props.location.state.user.id, { params: {bookingStatus: "PENDING"} })
        .then(res => {
    ...
    try {
      axios.get("http://Backend-Dev-dev.us-east-1.elasticbeanstalk.com/api/booking/all/user/" + this.props.location.state.user.id, { params: {bookingStatus: "COMPLETED"} })
        .then(res => {
          const bookings = res.data;
  ...
  handleClick = async booking => {
    ...
    try {
      await axios.put("http://Backend-Dev-dev.us-east-1.elasticbeanstalk.com/api/booking/" + booking.id, changedBooking);
    } catch (err) {
