            ...
            <div className="container profile">
              <form>
                ...
                <div className="form-group row field-row">
                  ...
                  <div className="col-sm-10">
                    <input type="password" className="form-control field-input" id="inputpassword" placeholder="Enter worker password" />
                  </div>
                </div>
                ...
                <div className="form-group row field-row">
                  ...
                  <div className="col-sm-10">
                    <input type="password" className="form-control field-input" id="inputpassword" placeholder="Enter worker password again" />
                  </div>
                </div>
