...
export default class ChooseWorker extends Component {
  constructor(props) {
    ...
    axios.get("http://ec2-18-234-246-40.compute-1.amazonaws.com:8080/api/worker/business/" + this.state.service.id.toString(), { headers: {Authorization: this.props.location.state.auth}, params: { start: this.state.startDate, end: this.state.endDate, isAdmin: false } })
      .then(res => {
